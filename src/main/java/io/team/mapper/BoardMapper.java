...
public interface BoardMapper {
	int create(int mem_id, int img_id, String mem_nickname, String brd_title, String brd_contents, int brd_state,
	...
	int update(int brd_id, int img_id, String mem_nickname, String brd_title, String brd_contents, int brd_state,
