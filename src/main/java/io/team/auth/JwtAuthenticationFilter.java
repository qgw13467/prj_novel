...
//			}
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		try {
			...
			int check = pointServiceLogic.attend(Integer.parseInt(map.get("memId")), PointPurpose.ATTENDANCE,
					attendance_point, map.get("memLastloginDatetime"));
...
//			System.out.println(token);
			...
			response.addCookie(new Cookie("memLastloginDatetime", date.substring(0, 23)));
